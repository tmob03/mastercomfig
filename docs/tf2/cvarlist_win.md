...
bugreporter_uploadasync                  : 1        : , "a"            : Upload attachments asynchronously
...
cl_allowdownload                         : 0        : , "a"            : Client downloads customization files
...
cl_cmdrate                               : 66       : , "a", "user"    : Max number of command packets sent to server per second
cl_coach_find_coach                      : cmd      :                  : Request a coach for the current game
cl_coach_toggle                          : cmd      :                  : Toggle coach status
cl_crosshair_blue                        : 255      : , "a", "cl"      : 
cl_crosshair_file                        : 0        : , "a", "cl"      : 
cl_crosshair_green                       : 221      : , "a", "cl"      : 
cl_crosshair_red                         : 138      : , "a", "cl"      : 
cl_crosshair_scale                       : 25       : , "a", "cl"      : 
...
cl_disablehtmlmotd                       : 1        : , "a", "cl"      : Disable HTML motds.
...
cl_hud_killstreak_display_alpha          : 100      : , "a", "cl"      : Adjusts font alpha value of killstreak notices.  Range is from 0 to 255 (default is 200).
cl_hud_killstreak_display_fontsize       : 0        : , "a", "cl"      : Adjusts font size of killstreak notices.  Range is from 0 to 2 (default is 1).
cl_hud_killstreak_display_time           : 2        : , "a", "cl"      : How long a killstreak notice stays on the screen (in seconds).  Range is from 0 to 100.
cl_hud_minmode                           : 1        : , "a", "cl"      : Set to 1 to turn on the advanced minimalist HUD mode.
cl_hud_playerclass_use_playermodel       : 0        : , "a", "cl"      : Use player model in player class HUD.
...
cl_mvm_wave_status_visible_during_wave   : 1        : , "a", "cl"      : Display full wave contents while a wave is active in MvM.
...
cl_spec_mode                             : 6        : , "a", "user", "server_can_execute", "cl" : spectator mode
...
cl_timeout                               : 60       : , "a"            : After this many seconds without receiving a packet from the server, the client will disconnect itself
...
cl_updaterate                            : 66       : , "a", "user"    : Number of packets per second of updates you are requesting from the server
...
glow_outline_effect_enable               : 0        : , "a", "cl"      : Enable entity outline glow effects.
...
hud_combattext_blue                      : 1        : , "a", "user", "cl" : 
...
hud_combattext_green                     : 1        : , "a", "user", "cl" : 
...
hud_medichealtargetmarker                : 1        : , "a", "cl"      : 
...
m_mousespeed                             : 0        : , "a", "cl"      : Windows mouse acceleration (0 to disable, 1 to enable [Windows 2000: enable initial threshold], 2 to enable secondary threshold [Windows 2000 only]).
...
mat_luxels                               : 0        : , "cheat"        : 
mat_managedtextures                      : 0        : , "a"            : If set, allows Direct3D to manage texture uploading at the cost of extra system memory
...
mat_software_aa_strength_vgui            : 0        : , "a", "cl"      : Same as mat_software_aa_strength, but forced to this value when called by the post vgui AA pass.
...
r_ambientboost                           : 0        : , "a"            : Set to boost ambient term if it is totally swamped by local lights
...
tf_chargedfriends                        : 368076320 : , "a", "cl"      : 
tf_chat_popup_hold_time                  : 3        : , "a", "cl"      : 
...
tf_colorblindassist                      : 1        : , "a", "cl"      : Setting this to 1 turns on colorblind mode.
...
tf_dingalingaling                        : 1        : , "a", "cl"      : If set to 1, play a sound everytime you injure an enemy. The sound can be customized by replacing the 'tf/sound/ui/hitsound.wav' file.
...
tf_dingalingaling_lasthit                : 1        : , "a", "cl"      : If set to 1, play a sound whenever one of your attacks kills an enemy. The sound can be customized by replacing the 'tf/sound/ui/killsound.wav' file.
...
tf_explanations_backpackpanel            : 1        : , "a", "cl"      : Whether the user has seen explanations for this panel.
tf_explanations_charinfo_armory_panel    : 0        : , "a", "cl"      : Whether the user has seen explanations for this panel.
tf_explanations_charinfopanel            : 1        : , "a", "cl"      : Whether the user has seen explanations for this panel.
...
tf_explanations_store                    : 1        : , "a", "cl"      : Whether the user has seen explanations for this panel.
...
tf_hud_show_servertimelimit              : 1        : , "a", "cl"      : Display time left before the current map ends.
...
tf_medigun_autoheal                      : 1        : , "a", "user", "cl" : Setting this to 1 will cause the Medigun's primary attack to be a toggle instead of needing to be held down.
...
tf_mm_custom_ping                        : 175      : , "a", "cl"      : Custom ping tolerance in the matchmaking system.  See also tf_custom_ping_enabled.
...
tf_particles_disable_weather             : 1        : , "a", "cl"      : Disable particles related to weather effects.
...
tf_quest_map_intro_viewed                : 1        : , "a", "cl"      : 
...
tf_scoreboard_ping_as_text               : 1        : , "a", "cl"      : Show ping values as text in the scoreboard.
...
tf_sniper_fullcharge_bell                : 1        : , "a", "cl"      : 
...
tf_training_has_prompted_for_forums      : 1        : , "a", "cl"      : Whether the user has been prompted to view the new user forums.
tf_training_has_prompted_for_loadout     : 1        : , "a", "cl"      : Whether the user has been prompted to equip something in their loadout.
tf_training_has_prompted_for_offline_practice : 1        : , "a", "cl"      : Whether the user has been prompted to try offline practice.
tf_training_has_prompted_for_options     : 1        : , "a", "cl"      : Whether the user has been prompted to view the TF2 advanced options.
tf_training_has_prompted_for_training    : 2        : , "a", "cl"      : Whether the user has been prompted for training
...
viewmodel_fov                            : 70       : , "a", "cl"      : Sets the field-of-view for the viewmodel.
...
+zoom                                    : cmd      :                  : 
-zoom                                    : cmd      :                  : 
zoom_sensitivity_ratio                   : 0        : , "a", "cl"      : Additional mouse sensitivity scale factor applied when FOV is zoomed in.
--------------
3573 total convars/concommands
```
